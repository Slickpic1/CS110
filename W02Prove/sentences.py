...
def get_verb(quantity,tense):
    ...
    """
    #Define list of past, present, and future tense verbs
    ...
    if tense == "future":
        verb = random.choice(future_verbs)

    elif tense == "past":
        verb = random.choice(past_verbs)

    elif tense == "present" and quantity == 1:
        verb = random.choice(present_singular_verbs)

    else:
        verb = random.choice(present_plural_verbs)
...
def get_noun(quantity):
    ...
    Return: a randomly chosen noun.
    """
    #Define singular and plural noun lists
    singular_nouns = ["bird", "boy", "car", "cat", "child","dog"
...
def get_prepositional_phrase(quantity):
    ...
    phrase = f"{preposition} {word} {adjective} {noun}"
    return phrase

def get_adjective():
    """Choose a random adjective from the following list
        "good", "big", "small", "doglike", "hot", "cold",
        "expensive", "difficult", "easy"
    Parameters:
        None

    Return: random adjective
    """
    adjectives = ["good", "big", "small", "doglike", "hot", "cold",
                  "expensive", "difficult", "easy"]
...
def make_sentence(quantity,tense):
    ...
    sentence = f"{word.capitalize()} {adjective} {noun} {prepositional_phrase1} {verb} {prepositional_phrase2}.\n"
